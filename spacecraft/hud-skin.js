...
(function(){
  var ICON={dashboard:'squares-four',bases:'planet',planner:'flask',chain:'flow-arrow',profit:'trend-up',market:'currency-circle-dollar',database:'database',settings:'gear-six',admin:'shield-check',map:'map-trifold'};
